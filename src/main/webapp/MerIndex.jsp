...
<div class="layui-layout layui-layout-admin" style="opacity: 0.80;">
    <div class="layui-header layui-bg-black">
        ...
        <ul class="layui-nav layui-layout-left">
            <li class="layui-nav-item" style="font-size: 25px;font-style: italic;"><i class="layui-icon layui-icon-util" style="font-size: 25px;"></i>商品信息管理系统</li>
        </ul>
    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            <ur class="layui-nav layui-nav-tree"  lay-filter="test">
                ...
                <li class="layui-nav-item layui-nav-itemed"><a href="goodsAllServlet" style="font-size: 20px;" target="main_self_frame">&nbsp;&nbsp;&nbsp;<i class="layui-icon layui-icon-friends" style="font-size: 20px;"></i>&nbsp;&nbsp;商品管理</a></li>
            </ur>
        </div>
    </div>
    <div class="layui-body">
        <iframe src="main.html" name="main_self_frame" frameborder="0" class="layadmin-iframe" width="100%" height="100%" style="background-color: white;">A</iframe>
    </div>
</div>
